...
import { Activity, LineChart as LineChartIcon, PieChart as PieChartIcon, FileText, GraduationCap, AlertTriangle, CheckCircle, Brain, Target, ShieldAlert, Upload } from 'lucide-react';
      ...
      {activeTab === 'documents' && (
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
            ...
            <button 
              onClick={() => navigate('/producer/cks-analiz')}
              className="mt-4 md:mt-0 flex items-center px-4 py-2 bg-agri-600 text-white rounded-lg hover:bg-agri-700 transition-colors text-sm font-medium">
