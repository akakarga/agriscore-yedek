...
import { Home, LineChart, Wallet, LogOut, GraduationCap, FileText, CheckSquare, Wheat } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-slate-50 print:bg-white print:h-auto">
      ...
      <main className="flex-1 overflow-auto print:overflow-visible">
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 print:hidden shadow-sm">
